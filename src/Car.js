    ...
    constructor()
    {
        ...
        window.setInterval(function()
        {
            setTimeout(() => 
            {
                if(this.direction > 0)
                {
                    this.car = new PIXI.Sprite(PIXI.loader.resources["pngs/AudiRL.png"].texture); //  <= direction <=
                    this.car.scale.set(0.4, 0.4 );
                    this.car.position.set(this.container.width, 0);
                } else {
                    this.car = new PIXI.Sprite(PIXI.loader.resources["pngs/Audi.png"].texture);  //  => direction =>
                    this.car.scale.set(0.4, 0.4 );
                    this.car.position.set(-renderer.width * 0.3, 0);
                }
